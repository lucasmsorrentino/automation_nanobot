...
# Implementação movida para nodes_actions.py; re-export abaixo mantém o
# caminho de import antigo funcionando.
# ---------------------------------------------------------------------------

from ufpr_automation.graph.nodes_actions import capturar_corpus_humano  # noqa: E402,F401
