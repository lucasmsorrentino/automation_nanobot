...
class LLMClient:
    ...
    async def self_refine_async(
        ...
        critique_prompt += (
            ...
            "6. A resposta NÃO contém o anti-padrão \"procure a Coordenação\" / "
            "\"entre em contato com a Coordenação\" / \"consulte a Coordenação\" / "
            "\"consulte a Secretaria\"? O agente É a Coordenação do Curso de Design "
            "Gráfico — mandar o aluno procurar a Coordenação é mandá-lo procurar a si "
            "mesmo. Se houver dúvida, deve dizer \"responda este e-mail\" ou citar "
            "outro setor (COAPPE, PRAE, AUI, PROGRAP, SIBI, PROGEPE, NAA, PRPPG).\n\n"
